...
status.get('/', async (c) => {
  // 1. Latest open incident (highest-severity wins if multiple are open,
  // which is the right rendering for a status banner).
  ...
  // 2. Last 90 days of incidents (resolved or otherwise) for the timeline.
