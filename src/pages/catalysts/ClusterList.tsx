  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          onClick={onCreate}
          className="flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium bg-accent/10 text-accent hover:bg-accent/20 active:scale-[0.96] transition-[background-color,color,box-shadow,transform] duration-[var(--dur-press)] [transition-timing-function:var(--ease-out)]"
        >
          <Plus size={12} /> New
        </button>
      </div>
