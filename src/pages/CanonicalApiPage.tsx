...
const methodColor: Record<string, string> = {
  ...
  POST: 'bg-[var(--accent)]/10 text-[var(--accent)] border-[var(--accent)]/20',
  PUT: 'bg-[var(--accent)]/10 text-[var(--accent)] border-[var(--accent)]/20',
  PATCH: 'bg-[var(--accent)]/10 text-[var(--accent)] border-[var(--accent)]/20',
  DELETE: 'bg-red-500/10 text-red-400 border-red-500/20'};

const domainColor: Record<string, string> = {
  finance: 'text-emerald-400',
  procurement: 'text-[var(--accent)]',
  'supply-chain': 'text-[var(--accent)]',
  hr: 'text-[var(--accent)]',
  sales: 'text-pink-600',
  inventory: 'text-[var(--accent)]',
  crm: 'text-orange-400'};
              ...
              <Card key={ep.id} hover>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs font-mono text-[var(--accent)] mt-0.5">{ep.path}</p>
                ...
                <div className="space-y-1">
                  {entity.fields.map((f) => (
                    <div key={f} className="flex items-center gap-2 text-xs">
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent)]/100 flex-shrink-0" />
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4 text-xs text-gray-400">
                  <span className="px-2 py-1 rounded bg-white/[0.04] border border-white/[0.06]">Catalyst / Chat</span>
                  <ArrowRight className="w-3 h-3 flex-shrink-0" />
                  <span className="px-2 py-1 rounded bg-orange-500/15 text-orange-400 border border-orange-500/20">Canonical API</span>
                  <ArrowRight className="w-3 h-3 flex-shrink-0" />
                  <span className="px-2 py-1 rounded bg-white/[0.04] border border-white/[0.06]">ERP Adapter</span>
                  <ArrowRight className="w-3 h-3 flex-shrink-0" />
