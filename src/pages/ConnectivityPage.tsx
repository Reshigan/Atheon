  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-[var(--accent)]/100/15 flex items-center justify-center">
        ...
        <TabPanel>
          <Card className="border-[var(--accent)]/20">
            <div className="flex items-start gap-3">
              <Bot className="w-5 h-5 text-[var(--accent)] mt-0.5 flex-shrink-0" />
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4 text-xs text-gray-400">
                  <span className="px-2 py-1 rounded bg-[var(--accent)]/10 text-[var(--accent)] border border-[var(--accent)]/20">Finance Catalyst</span>
                  <ArrowRight className="w-3 h-3 flex-shrink-0" />
                  <span className="px-2 py-1 rounded bg-white/[0.04] border border-white/[0.06]">A2A Protocol</span>
                  <ArrowRight className="w-3 h-3 flex-shrink-0" />
                  <span className="px-2 py-1 rounded bg-[var(--accent)]/10 text-[var(--accent)] border border-[var(--accent)]/20">Supply Chain Catalyst</span>
                </div>
