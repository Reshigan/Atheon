...
export function ConnectivityPage() {
 ...
 <p className="text-2xl font-bold t-primary mt-1">{mcpServers.length}</p>
 </Card>
 <Card>
 ...
 <p className="text-2xl font-bold t-primary mt-1">{mcpServers.reduce((s, m) => s + m.tools.length, 0)}</p>
 </Card>
 <Card>
 ...
 <div key={tool.name} className="flex items-center justify-between p-2 rounded bg-[var(--bg-secondary)] border border-[var(--border-card)]">
 <div>
 ...
 <span className="px-2 py-1 rounded bg-accent/10 text-accent border border-accent/20">Finance Catalyst</span>
 <ArrowRight className="w-3 h-3 flex-shrink-0" />
 <span className="px-2 py-1 rounded bg-[var(--bg-secondary)] border border-[var(--border-card)]">A2A Protocol</span>
 <ArrowRight className="w-3 h-3 flex-shrink-0" />
 <span className="px-2 py-1 rounded bg-accent/10 text-accent border border-accent/20">Supply Chain Catalyst</span>
 </div>
 <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
 <div className=" p-3 rounded bg-[var(--bg-secondary)] border border-[var(--border-card)]">
 <span className="text-xs font-semibold t-primary">Discovery</span>
 <p className="text-[10px] text-gray-400 mt-1">Catalysts register Agent Cards at /.well-known/agent.json</p>
 </div>
 <div className=" p-3 rounded bg-[var(--bg-secondary)] border border-[var(--border-card)]">
 <span className="text-xs font-semibold t-primary">Communication</span>
 <p className="text-[10px] text-gray-400 mt-1">JSON-RPC over HTTP/2. Structured task/result protocol.</p>
 </div>
 <div className=" p-3 rounded bg-[var(--bg-secondary)] border border-[var(--border-card)]">
 <span className="text-xs font-semibold t-primary">Governance</span>
