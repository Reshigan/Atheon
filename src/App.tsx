...
const WebhookSecretsPage = lazy(() => import("@/pages/WebhookSecretsPage"));
      ...
      <Suspense fallback={<RouteLoader />}>
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            <Route path="/webhook-secrets" element={<ProtectedRoute allowedRoles={PLATFORM_ADMIN_ROLES}><WebhookSecretsPage /></ProtectedRoute>} />
          </Route>
        </Routes>
      </Suspense>
      </BrandProvider>
