...
/** Glass gradient defs — shared across icons */
function GlassGradient({ id }: { id: string }) {
  return (
    <defs>
      <linearGradient id={`${id}-grad`} x1="3" y1="3" x2="21" y2="21">
        <stop offset="0%" stopColor="#6b93ff" stopOpacity="0.9" />
        <stop offset="100%" stopColor="#4e7cf6" stopOpacity="0.6" />
      </linearGradient>
    </defs>
  );
}
...
export function IconDashboard({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <rect x="13" y="13" width="8" height="8" rx="2.5" fill="url(#dash-grad)" opacity="0.15" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
...
export function IconApex({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <path d="M12 2l-2 6h5.5l-3.5 4" fill="url(#apex-grad)" opacity="0.12" />
    </svg>
  );
}
...
export function IconCatalysts({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <path d="M14 4l-4.5 10.5L20 10 14 4z" fill="url(#cat-grad)" opacity="0.10" />
      <circle cx="19" cy="5" r="1.5" fill="url(#cat-grad)" opacity="0.5" />
...
export function IconMind({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <path d="M12 2a7 7 0 00-7 7c0 2.5 1.3 4.6 3.3 5.8L7.5 21h9l-.8-6.2A7 7 0 0012 2z" fill="url(#mind-grad)" opacity="0.08" />
...
export function IconMemory({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <GlassGradient id="mem" />
      <ellipse cx="12" cy="6" rx="8" ry="3" stroke="currentColor" strokeWidth="1.5" />
      <ellipse cx="12" cy="6" rx="8" ry="3" fill="url(#mem-grad)" opacity="0.10" />
...
export function IconChat({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <path d="M21 12c0 4.418-4.03 8-9 8-1.6 0-3.1-.36-4.4-1L3 21l1.8-3.6C3.66 16 3 14.1 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" fill="url(#chat-grad)" opacity="0.08" />
...
export function IconClients({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <GlassGradient id="cli" />
      <circle cx="9" cy="7" r="3" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="9" cy="7" r="3" fill="url(#cli-grad)" opacity="0.10" />
...
export function IconIAM({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <path d="M12 2L4 6v5c0 5.25 3.4 10.15 8 11.4 4.6-1.25 8-6.15 8-11.4V6l-8-4z" fill="url(#iam-grad)" opacity="0.08" />
...
export function IconControlPlane({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <rect x="6" y="6" width="12" height="12" rx="2.5" fill="url(#cp-grad)" opacity="0.10" />
...
export function IconCanonicalApi({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <GlassGradient id="api" />
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="12" cy="12" r="9" fill="url(#api-grad)" opacity="0.06" />
...
export function IconERPAdapters({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <rect x="6" y="7" width="12" height="5" rx="2.5" fill="url(#erp-grad)" opacity="0.10" />
...
export function IconConnectivity({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      ...
      <circle cx="12" cy="12" r="1.5" fill="url(#conn-grad)" opacity="0.25" />
    </svg>
  );
}
...
export function IconAudit({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <GlassGradient id="audit" />
      <rect x="5" y="3" width="14" height="18" rx="2.5" stroke="currentColor" strokeWidth="1.5" />
      <rect x="5" y="3" width="14" height="18" rx="2.5" fill="url(#audit-grad)" opacity="0.06" />
...
export function IconSettings({ size = 18, ...props }: IconProps) {
  return (
    <svg {...defaultProps(size)} {...props}>
      <GlassGradient id="set" />
      <circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="12" cy="12" r="3" fill="url(#set-grad)" opacity="0.15" />
